<script>
  ...
  const bootstrap = "/dashboard/assets/img/bootstrap.jpg";
  const angular = "/dashboard/assets/img/angular.jpg";
  const sketch = "/dashboard/assets/img/sketch.jpg";
  const react = "/dashboard/assets/img/react.jpg";
  const vue = "/dashboard/assets/img/react.jpg";

  const team1 = "/dashboard/assets/img/team-1-800x800.jpg";
  const team2 = "/dashboard/assets/img/team-2-800x800.jpg";
  const team3 = "/dashboard/assets/img/team-3-800x800.jpg";
  const team4 = "/dashboard/assets/img/team-4-470x470.png";
